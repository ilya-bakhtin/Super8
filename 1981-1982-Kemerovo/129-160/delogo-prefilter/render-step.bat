...
mkdir "%dir_f%"
rem "D:\Program Files\MeGUI\tools\mp4box\mp4box.exe" -add "%1\%2.h265#trackID=1:fps=18.0:par=1:1:name=" -add "%1\%2.m4a#trackID=1:name=" -tmp "%dir_f_ds%" -new "%1\%2m.mp4"
    "C:\Program Files\GPAC\mp4box.exe"               -add "%1\%2.h265#trackID=1:fps=18.0:par=1:1:name=" -add "%1\%2.m4a#trackID=1:name=" -tmp "%dir_f_ds%" -new "%1\%2m.mp4"
rmdir "%dir_f%"
